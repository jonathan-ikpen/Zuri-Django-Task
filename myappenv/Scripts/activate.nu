...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\New User\Downloads\zuri_django_project\myappenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\New User\Downloads\zuri_django_project\myappenv\Scripts\deactivate.nu'
